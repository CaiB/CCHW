...
add wave -noupdate -radix unsigned -childformat {{{/LEDCountCalc_testbench/dut/LEDCount[10]} -radix unsigned} {{/LEDCountCalc_testbench/dut/LEDCount[9]} -radix unsigned} {{/LEDCountCalc_testbench/dut/LEDCount[8]} -radix unsigned} {{/LEDCountCalc_testbench/dut/LEDCount[7]} -radix unsigned} {{/LEDCountCalc_testbench/dut/LEDCount[6]} -radix unsigned} {{/LEDCountCalc_testbench/dut/LEDCount[5]} -radix unsigned} {{/LEDCountCalc_testbench/dut/LEDCount[4]} -radix unsigned} {{/LEDCountCalc_testbench/dut/LEDCount[3]} -radix unsigned} {{/LEDCountCalc_testbench/dut/LEDCount[2]} -radix unsigned} {{/LEDCountCalc_testbench/dut/LEDCount[1]} -radix unsigned} {{/LEDCountCalc_testbench/dut/LEDCount[0]} -radix unsigned}} -expand -subitemconfig {{/LEDCountCalc_testbench/dut/LEDCount[10]} {-radix unsigned} {/LEDCountCalc_testbench/dut/LEDCount[9]} {-radix unsigned} {/LEDCountCalc_testbench/dut/LEDCount[8]} {-radix unsigned} {/LEDCountCalc_testbench/dut/LEDCount[7]} {-radix unsigned} {/LEDCountCalc_testbench/dut/LEDCount[6]} {-radix unsigned} {/LEDCountCalc_testbench/dut/LEDCount[5]} {-radix unsigned} {/LEDCountCalc_testbench/dut/LEDCount[4]} {-radix unsigned} {/LEDCountCalc_testbench/dut/LEDCount[3]} {-radix unsigned} {/LEDCountCalc_testbench/dut/LEDCount[2]} {-radix unsigned} {/LEDCountCalc_testbench/dut/LEDCount[1]} {-radix unsigned} {/LEDCountCalc_testbench/dut/LEDCount[0]} {-radix unsigned}} /LEDCountCalc_testbench/dut/LEDCount
add wave -noupdate /LEDCountCalc_testbench/dut/clk
add wave -noupdate /LEDCountCalc_testbench/dut/rst
add wave -noupdate /LEDCountCalc_testbench/dut/done
add wave -noupdate /LEDCountCalc_testbench/dut/cycle_cntr
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {463125 ps} 0}
