...
add wave -noupdate -radix decimal {/Test_DFT/DFTDUT/Octave1/OctaveData/Inter[0]}
add wave -noupdate -radix decimal {/Test_DFT/DFTDUT/Octave1/OctaveData/Inter[1]}
add wave -noupdate -radix decimal {/Test_DFT/DFTDUT/Octave1/OctaveData/Inter[2]}
add wave -noupdate -radix decimal {/Test_DFT/DFTDUT/Octave1/OctaveData/Inter[3]}
add wave -noupdate -radix decimal {/Test_DFT/DFTDUT/Octave1/OctaveData/Inter[4]}
add wave -noupdate -radix decimal {/Test_DFT/DFTDUT/Octave1/OctaveData/Inter[5]}
add wave -noupdate -radix decimal {/Test_DFT/DFTDUT/Octave1/OctaveData/Inter[6]}
add wave -noupdate -radix decimal {/Test_DFT/DFTDUT/Octave1/OctaveData/Inter[7]}
...
WaveRestoreCursors {{Cursor 1} {25703300 ps} 0}
