...
add wave -noupdate /Test_DFT/DFTDUT/readSample
...
add wave -noupdate /Test_DFT/DFTDUT/OctaveProcessingFinished
...
add wave -noupdate {/Test_DFT/DFTDUT/OctaveCounter[0]}
add wave -noupdate {/Test_DFT/DFTDUT/OctaveCounter[1]}
add wave -noupdate {/Test_DFT/DFTDUT/OctaveCounter[2]}
add wave -noupdate {/Test_DFT/DFTDUT/OctaveCounter[3]}
add wave -noupdate {/Test_DFT/DFTDUT/OctaveCounter[4]}
