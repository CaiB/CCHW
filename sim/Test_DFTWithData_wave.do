...
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[0]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[1]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[2]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[3]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[4]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[5]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[6]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[7]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[8]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[9]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[10]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[11]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[12]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[13]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[14]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[15]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[16]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[17]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[18]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[19]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[20]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[21]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[22]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[23]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[24]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[25]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[26]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[27]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[28]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[29]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[30]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[31]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[32]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[33]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[34]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[35]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[36]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[37]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[38]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[39]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[40]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[41]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[42]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[43]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[44]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[45]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[46]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[47]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[48]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[49]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[50]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[51]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[52]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[53]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[54]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[55]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[56]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[57]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[58]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[59]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[60]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[61]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[62]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[63]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[64]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[65]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[66]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[67]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[68]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[69]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[70]}
add wave -noupdate -group {Lower Octaves} -radix unsigned {/Test_DFT/outBins[71]}
...
add wave -noupdate -expand -group {Top Octave} -radix unsigned {/Test_DFT/outBins[96]}
add wave -noupdate -expand -group {Top Octave} -radix unsigned {/Test_DFT/outBins[97]}
add wave -noupdate -expand -group {Top Octave} -radix unsigned {/Test_DFT/outBins[98]}
add wave -noupdate -expand -group {Top Octave} -radix unsigned {/Test_DFT/outBins[99]}
add wave -noupdate -expand -group {Top Octave} -radix unsigned {/Test_DFT/outBins[100]}
add wave -noupdate -expand -group {Top Octave} -radix unsigned {/Test_DFT/outBins[101]}
add wave -noupdate -expand -group {Top Octave} -radix unsigned {/Test_DFT/outBins[102]}
add wave -noupdate -expand -group {Top Octave} -radix unsigned {/Test_DFT/outBins[103]}
add wave -noupdate -expand -group {Top Octave} -radix unsigned {/Test_DFT/outBins[104]}
add wave -noupdate -expand -group {Top Octave} -radix unsigned {/Test_DFT/outBins[105]}
add wave -noupdate -expand -group {Top Octave} -radix unsigned {/Test_DFT/outBins[106]}
add wave -noupdate -expand -group {Top Octave} -radix unsigned {/Test_DFT/outBins[107]}
add wave -noupdate -expand -group {Top Octave} -radix unsigned {/Test_DFT/outBins[108]}
add wave -noupdate -expand -group {Top Octave} -radix unsigned {/Test_DFT/outBins[109]}
add wave -noupdate -expand -group {Top Octave} -radix unsigned {/Test_DFT/outBins[110]}
add wave -noupdate -expand -group {Top Octave} -radix unsigned {/Test_DFT/outBins[111]}
add wave -noupdate -expand -group {Top Octave} -radix unsigned {/Test_DFT/outBins[112]}
add wave -noupdate -expand -group {Top Octave} -radix unsigned {/Test_DFT/outBins[113]}
add wave -noupdate -expand -group {Top Octave} -radix unsigned {/Test_DFT/outBins[114]}
add wave -noupdate -expand -group {Top Octave} -radix unsigned {/Test_DFT/outBins[115]}
add wave -noupdate -expand -group {Top Octave} -radix unsigned {/Test_DFT/outBins[116]}
add wave -noupdate -expand -group {Top Octave} -radix unsigned {/Test_DFT/outBins[117]}
add wave -noupdate -expand -group {Top Octave} -radix unsigned {/Test_DFT/outBins[118]}
add wave -noupdate -expand -group {Top Octave} -radix unsigned {/Test_DFT/outBins[119]}
...
add wave -noupdate -radix decimal /Test_DFT/DFTDUT/SinOutput
add wave -noupdate -radix decimal /Test_DFT/DFTDUT/CosOutput
add wave -noupdate -divider {Octave 1}
add wave -noupdate -radix decimal /Test_DFT/DFTDUT/Octave1/newSample
add wave -noupdate -radix unsigned /Test_DFT/DFTDUT/Octave1/trigPosReq
add wave -noupdate -radix decimal /Test_DFT/DFTDUT/Octave1/sinData
add wave -noupdate -radix decimal /Test_DFT/DFTDUT/Octave1/cosData
add wave -noupdate -radix decimal /Test_DFT/DFTDUT/Octave1/SinProd
add wave -noupdate -radix decimal /Test_DFT/DFTDUT/Octave1/CosProd
add wave -noupdate -radix decimal /Test_DFT/DFTDUT/Octave1/SinSum
add wave -noupdate -radix decimal /Test_DFT/DFTDUT/Octave1/CosSum
add wave -noupdate -radix unsigned -childformat {{{/Test_DFT/DFTDUT/Octave1/magnitude[0]} -radix unsigned} {{/Test_DFT/DFTDUT/Octave1/magnitude[1]} -radix unsigned} {{/Test_DFT/DFTDUT/Octave1/magnitude[2]} -radix unsigned} {{/Test_DFT/DFTDUT/Octave1/magnitude[3]} -radix unsigned} {{/Test_DFT/DFTDUT/Octave1/magnitude[4]} -radix unsigned} {{/Test_DFT/DFTDUT/Octave1/magnitude[5]} -radix unsigned} {{/Test_DFT/DFTDUT/Octave1/magnitude[6]} -radix unsigned} {{/Test_DFT/DFTDUT/Octave1/magnitude[7]} -radix unsigned} {{/Test_DFT/DFTDUT/Octave1/magnitude[8]} -radix unsigned} {{/Test_DFT/DFTDUT/Octave1/magnitude[9]} -radix unsigned} {{/Test_DFT/DFTDUT/Octave1/magnitude[10]} -radix unsigned} {{/Test_DFT/DFTDUT/Octave1/magnitude[11]} -radix unsigned} {{/Test_DFT/DFTDUT/Octave1/magnitude[12]} -radix unsigned} {{/Test_DFT/DFTDUT/Octave1/magnitude[13]} -radix unsigned} {{/Test_DFT/DFTDUT/Octave1/magnitude[14]} -radix unsigned} {{/Test_DFT/DFTDUT/Octave1/magnitude[15]} -radix unsigned} {{/Test_DFT/DFTDUT/Octave1/magnitude[16]} -radix unsigned} {{/Test_DFT/DFTDUT/Octave1/magnitude[17]} -radix unsigned} {{/Test_DFT/DFTDUT/Octave1/magnitude[18]} -radix unsigned} {{/Test_DFT/DFTDUT/Octave1/magnitude[19]} -radix unsigned} {{/Test_DFT/DFTDUT/Octave1/magnitude[20]} -radix unsigned} {{/Test_DFT/DFTDUT/Octave1/magnitude[21]} -radix unsigned} {{/Test_DFT/DFTDUT/Octave1/magnitude[22]} -radix unsigned} {{/Test_DFT/DFTDUT/Octave1/magnitude[23]} -radix unsigned}} -subitemconfig {{/Test_DFT/DFTDUT/Octave1/magnitude[0]} {-height 15 -radix unsigned} {/Test_DFT/DFTDUT/Octave1/magnitude[1]} {-height 15 -radix unsigned} {/Test_DFT/DFTDUT/Octave1/magnitude[2]} {-height 15 -radix unsigned} {/Test_DFT/DFTDUT/Octave1/magnitude[3]} {-height 15 -radix unsigned} {/Test_DFT/DFTDUT/Octave1/magnitude[4]} {-height 15 -radix unsigned} {/Test_DFT/DFTDUT/Octave1/magnitude[5]} {-height 15 -radix unsigned} {/Test_DFT/DFTDUT/Octave1/magnitude[6]} {-height 15 -radix unsigned} {/Test_DFT/DFTDUT/Octave1/magnitude[7]} {-height 15 -radix unsigned} {/Test_DFT/DFTDUT/Octave1/magnitude[8]} {-height 15 -radix unsigned} {/Test_DFT/DFTDUT/Octave1/magnitude[9]} {-height 15 -radix unsigned} {/Test_DFT/DFTDUT/Octave1/magnitude[10]} {-height 15 -radix unsigned} {/Test_DFT/DFTDUT/Octave1/magnitude[11]} {-height 15 -radix unsigned} {/Test_DFT/DFTDUT/Octave1/magnitude[12]} {-height 15 -radix unsigned} {/Test_DFT/DFTDUT/Octave1/magnitude[13]} {-height 15 -radix unsigned} {/Test_DFT/DFTDUT/Octave1/magnitude[14]} {-height 15 -radix unsigned} {/Test_DFT/DFTDUT/Octave1/magnitude[15]} {-height 15 -radix unsigned} {/Test_DFT/DFTDUT/Octave1/magnitude[16]} {-height 15 -radix unsigned} {/Test_DFT/DFTDUT/Octave1/magnitude[17]} {-height 15 -radix unsigned} {/Test_DFT/DFTDUT/Octave1/magnitude[18]} {-height 15 -radix unsigned} {/Test_DFT/DFTDUT/Octave1/magnitude[19]} {-height 15 -radix unsigned} {/Test_DFT/DFTDUT/Octave1/magnitude[20]} {-height 15 -radix unsigned} {/Test_DFT/DFTDUT/Octave1/magnitude[21]} {-height 15 -radix unsigned} {/Test_DFT/DFTDUT/Octave1/magnitude[22]} {-height 15 -radix unsigned} {/Test_DFT/DFTDUT/Octave1/magnitude[23]} {-height 15 -radix unsigned}} /Test_DFT/DFTDUT/Octave1/magnitude
add wave -noupdate /Test_DFT/DFTDUT/Octave1/enable
add wave -noupdate /Test_DFT/DFTDUT/Octave1/mathOp
add wave -noupdate -radix unsigned /Test_DFT/DFTDUT/Octave1/bin
add wave -noupdate -radix unsigned /Test_DFT/DFTDUT/Octave1/CurrentTrigTablePos
add wave -noupdate -radix unsigned /Test_DFT/DFTDUT/Octave1/EndTrigTablePos
add wave -noupdate -radix decimal /Test_DFT/DFTDUT/Octave1/sample0
add wave -noupdate -radix decimal /Test_DFT/DFTDUT/Octave1/sample1
add wave -noupdate -radix decimal /Test_DFT/DFTDUT/Octave1/SampleOperand
...
add wave -noupdate /Test_DFT/DFTDUT/Octave1/TrigTableCountersCur/increment
add wave -noupdate -radix unsigned /Test_DFT/DFTDUT/Octave1/TrigTableCountersCur/bin
add wave -noupdate -radix unsigned /Test_DFT/DFTDUT/Octave1/TrigTableCountersCur/ThisBinMax
add wave -noupdate -radix unsigned -childformat {{{/Test_DFT/DFTDUT/Octave1/TrigTableCountersCur/counterOut[5]} -radix unsigned} {{/Test_DFT/DFTDUT/Octave1/TrigTableCountersCur/counterOut[4]} -radix unsigned} {{/Test_DFT/DFTDUT/Octave1/TrigTableCountersCur/counterOut[3]} -radix unsigned} {{/Test_DFT/DFTDUT/Octave1/TrigTableCountersCur/counterOut[2]} -radix unsigned} {{/Test_DFT/DFTDUT/Octave1/TrigTableCountersCur/counterOut[1]} -radix unsigned} {{/Test_DFT/DFTDUT/Octave1/TrigTableCountersCur/counterOut[0]} -radix unsigned}} -subitemconfig {{/Test_DFT/DFTDUT/Octave1/TrigTableCountersCur/counterOut[5]} {-height 15 -radix unsigned} {/Test_DFT/DFTDUT/Octave1/TrigTableCountersCur/counterOut[4]} {-height 15 -radix unsigned} {/Test_DFT/DFTDUT/Octave1/TrigTableCountersCur/counterOut[3]} {-height 15 -radix unsigned} {/Test_DFT/DFTDUT/Octave1/TrigTableCountersCur/counterOut[2]} {-height 15 -radix unsigned} {/Test_DFT/DFTDUT/Octave1/TrigTableCountersCur/counterOut[1]} {-height 15 -radix unsigned} {/Test_DFT/DFTDUT/Octave1/TrigTableCountersCur/counterOut[0]} {-height 15 -radix unsigned}} /Test_DFT/DFTDUT/Octave1/TrigTableCountersCur/counterOut
...
add wave -noupdate /Test_DFT/DFTDUT/Octave2/OctaveData/Address
add wave -noupdate /Test_DFT/DFTDUT/Octave2/OctaveData/RAMWrite
add wave -noupdate /Test_DFT/DFTDUT/Octave2/OctaveData/RAMIn
add wave -noupdate /Test_DFT/DFTDUT/Octave2/OctaveData/RAMOut
...
add wave -noupdate /Test_DFT/DFTDUT/Octave2/OctaveData/Present
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {411239100 ps} 0}
...
update
WaveRestoreZoom {411237900 ps} {411245900 ps}
